...
public class Practicante_EP {
	...
	@Id
    @Column(name = "id")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seqPracticante_EP")
    @SequenceGenerator(name = "seqPracticante_EP", allocationSize = 1, sequenceName = "SEQ_PRACTICANTE_EP")
    private Long id;
